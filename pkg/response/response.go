...
// Every endpoint should return data wrapped in this structure
// to ensure consistent client-side parsing.
...
// The actual error details should be logged server-side, not exposed to clients.
