    ...
    <div style={{ maxWidth: '640px', margin: '60px auto', padding: '0 20px' }}>
      <div className="card" style={{ padding: '32px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{
                ...
                backgroundColor: wsStatus === 'connected' ? 'rgba(45, 122, 79, 0.12)' : 'rgba(107, 100, 96, 0.12)',
                color: wsStatus === 'connected' ? 'var(--v-color-success)' : 'var(--v-color-warm-gray)',
                ...
                <span style={{
                  ...
                  height: '6px',
                  borderRadius: '50%',
                  backgroundColor: wsStatus === 'connected' ? 'var(--v-color-success)' : 'var(--v-color-warm-gray)',
                }} />
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'space-between' }}>
          ...
          <Button variant="primary" size="md" onClick={() => onNavigateVote(initialData.pollId)}>
            Go to Vote Screen
          </Button>
        </div>
      </div>
